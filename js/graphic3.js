...
$(document).ready(function() {
    ...
    function initPapa() {
          Papa.parse('https://docs.google.com/spreadsheets/d/e/2PACX-1vRcIn0lK_8b9FuIZGjMTn0axFrzDHSiAPeVyGgpm5028H0XjoMYigGIvqVbM2-RmFfQHElpggsq_UYC/pub?output=csv', {
          download: true,
          header: true,
  ...
  function writeTable(data) {
    ...
    $('#graphic').html(
      '<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-condensed table-responsive compact" id="jobs2023"></table>'
    );
