...
$(document).ready(function() {
    ...
    function initPapa() {
          Papa.parse('https://docs.google.com/spreadsheets/d/e/2PACX-1vS1CbvrQ_HkxEYOXFu1EqvPCuLYPWS01sWHyzHDFKdnJpy304JQiusK_fJ1ZZvBDYwid4MhEsMBNbdg/pub?output=csv', {
          download: true,
          header: true,
  ...
  function writeTable(data) {
    ...
    $('#graphic').html(
      '<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-condensed table-responsive compact" id="jobs2022"></table>'
    );
