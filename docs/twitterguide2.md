...
<h3>A Guide to Twitter Safety for Academics (and Everyone Else)</h3>
<p></p>
<em>Paula R. Curtis</em><br>
<em>April __, 2021</em><br>
<p></p>

<p></p>
At the start of 2021, I created <em><a href="/docs/twitterguide/">A Guide to Best Twitter Practices for Academics (and Everyone Else)</a></em>, which provided explanations and tips for using Twitter effectively and respectfully. As I have <a href="https://apjjf.org/2021/22/Curtis.html">written elsewhere</a> and is generally apparent to anyone who engages online), not everyone using social media is doing so with good intentions. This article is an extension of the <em><a href=/events/AASDD2022/">Academics Online</a></em> series of virtual events on digital harassment in Asian Studies hosted through the Association for Asian Studies' Digital Dialogues. ALthough public-facing work and digital-engagement is increasingly demanded of educators, students, and various types of workers, it is not a standard part of professional development skills or curricula, nor is how to navigate these spaces, or how to protect oneself. This article therefore provides practical safety tips for managing one's Twitter experience, whether you're learning how to recognize questionable users or in need of help mass blocking trolls.
<p></p>
<hr>
<p></p>
<div style>
...
Where can our awareness of bad actors in the Twitterverse begin? Given the very public nature of Twitter and the ease with which content can be shared, encountering suspicious accounts is inevitable. When we get a reply or a follow from such a user, we ask yourselves: Who IS this person? Are they an automated bot? If they have the blank, default Twitter user picture are they actually a real person who has only just created their profile, or could they be a fake account? Are they just someone I suspect I just don’t want to have follow me? The most important thing to remember from the beginning is that <b>what ever the reason might be that you don’t want this person interacting with you, your choice to not engage with them is valid.</b> There is no rule that anyone who follows you is entitled to follow you. This is a decision in your hands.
<p></p>

So what makes someone’s profile suspicious, and what are some common identifying characteristics that can be seen as red flags?
<p></p>

<h5>String of Random Numbers Person</h5>
<p></p>
When you sign up for Twitter your username (also known as a "handle") your username presents as an automatically-generated string of random numbers. The first thing one should do is change this to an alternative username. For example, rather than @paular7363949, my username is now @paularcurtis. This change is one possible sign of human intervention; if someone is potentially creating hundreds of bots (fake accounts) all at once, it's unlikely they'll go in and change every username. When a random person follows you and they seem to have an inexplicable string of numbers as their handle, it’s often a just-launched bot and there is no human regularly operating the account.
<p></p>

I should add as a caveat that you WILL find people who don’t bother to change this string of numbers—that’s a personal choice—but if you don’t and your profile or content does not make very clear who you are then you risk being mistaken for one of these accounts. And, generally, it’s harder to find and share your content.
<p></p>
<div style>
...
<p></p>
Is this always the case? Not necessarily. Sometimes bots have rather real-looking handles. And sometimes someone doesn't change their string of random numbers because it doesn't bother them. But if you don’t want your account to be mistaken for a bot and blocked, then it's best to change it right away before you begin following people. Username changes also make it easier to find you and share your content.
<p></p>
<p></p>
